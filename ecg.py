...
# model = load_model(r"C:\Users\HP\Downloads\ecg_model (1).h5")
...
#     predefined_prompt=f"You are a ECG Analyzer you are being provided with ECG image{file_path} and reslut of it {result} like 'Myocardial Infarction', 'History of MI', 'Abnormal Heartbeat', 'Normal Person' you have to assist user regarding his analysis report "
...
#     img = img.reshape(1, img_size, img_size, 3)  # Reshape for model input
...
# # # Example: Test on a sample ECG image
# # test_image_path = r"C:\Users\HP\Downloads\MI(1).jpg" 
# # predict_ecg(test_image_path)
